...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">EventOn</a></div>
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				...
				<div class="book_button"><a href="#">Think about it</a></div>
	...
	<div class="home">
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(images/yellow.jpg)"></div>
					<div class="home_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_content text-center">
										<div class="home_title">EventOn</div>
										<div class="booking_form_container">
											<form action="#" class="booking_form">
												<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start">
													<div class="booking_input_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
														<div><input type="text" class="booking_input" placeholder="Ciudad, Estado, Municipio..." required="required"></div>
														<div><input type="text" class="booking_input" placeholder="Precio" required="required"></div>
														<div><input type="number" class="booking_input" placeholder="No. Personas" required="required"></div>
														<div><input type="text" class="datepicker booking_input" placeholder="Fecha" required="required"></div>
													</div>
													<div><button class="booking_button trans_200">Buscar</button></div>
												</div>
											</form>
										</div>
									</div>
